...
file_path = (
    ...
    "Macroeconomic_Economy_Predictive_GlobalData.xlsx"
)
...
df_raw = df_raw.iloc[17:].reset_index(drop=True)
...
df_unpivot["Year"] = pd.to_datetime(
...
filled_df.write.format("delta").mode("overwrite").saveAsTable("Sales_Forecasting.bronze.DRV_Macro_Econ")
