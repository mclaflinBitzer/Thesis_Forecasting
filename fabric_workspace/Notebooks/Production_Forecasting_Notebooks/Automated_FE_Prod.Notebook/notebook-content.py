...
ACT_COLS_RENAME = config_obj['automated_act_cols_rename']
DRV_COLS_RENAME = config_obj['automated_drv_cols_rename']

actuals_table = config_obj['cutoff_data_table'] 


feature_diagnostics_file = config_obj['automated_feature_diagnostics_file']
selected_feature_file = config_obj['automated_feature_diagnostics_file']
xgboost_diagnostics_file = config_obj['automated_feature_diagnostics_file']
xgboost_selected_feature_file = config_obj['automated_feature_diagnostics_file']
dl_selected_feature_file =config_obj['automated_feature_diagnostics_file']



series = ['series']

## the following are read directly from the static set section of the config file
# driver_table | elasticnet_init_features | xgboost_init_features | dl_init_features 
