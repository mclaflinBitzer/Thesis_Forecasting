...
## driver_table is from the config file 
...
ACT_RENAME = config_obj['manual_act_rename']
DRV_RENAME = config_obj['manual_drv_rename']

num_features = manual_driver_feature_num

stationary_stats_output_path = config_obj['manual_stationary_stats_output_path']
pairs_path = config_obj['manual_pairs_path']
joined_act_f_dir = config_obj['manual_joined_act_f_dir']
ccf_output_dir = config_obj['manual_ccf_output_dir']
final_feature_dir = config_obj['manual_final_feature_dir']
