...
# ==========================================================
def train_xgboost_global(train_sdf: DataFrame, feature_cols):
...
def fit_xgboost_global(sdf: DataFrame) -> DataFrame:
    ...
    if training_examples.limit(1).count() > 0 and future_examples.limit(1).count() > 0:
        ...
        model_final, feature_cols = train_xgboost_global(train_final, feature_cols)
...
# # Potential code to resolve data leakage and to do hyperparameter training/selection prior to forecasting
